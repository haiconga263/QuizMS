...
﻿﻿<%
    ...
    Exam ex = exBUS.getNameExamById(id);
%>
<!DOCTYPE html>
<html>
    <head>
            ...
            <div class="container-fluid" id="content">
                <div class="row justify-content-center mt-5 mb-5">
                    <div class="col-6 text-center mt-5 mb-5">
                        <h2 class="mt-5 mb-5 clr-red-900"><%= ex.getDescription()%></h2>
                        <h4 class="mt-5 mb-5">Thời gian: <span class="clr-red-900 font-weight-bold"><%= ex.getTime() + " Phút" %></span></h4>
                        <a id="btnstart" class="btn bg-orange-700 clr-none font-weight-bold btn-lg" href="exam-question.jsp?id=<%=id%>">
                            Bắt đầu
                        </a>
                    </div>
                </div>
